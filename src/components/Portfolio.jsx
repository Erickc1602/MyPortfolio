                ...
                <ul class="awilo_fn_masonry">
                  ...
                  <Link to="https://goatededc.netlify.app/">
                    <li class="awilo_fn_masonry_in">
                      <div class="list_item">
                        ...
                        <div class="title_holder">
                          ...
                          <div class="title_name">
                            <h3>
                              <a href="https://goatededc.netlify.app/">
                                GOATED
                              </a>
                            </h3>
                          </div>
                      ...
                      <p style={{ color: "white" }}>
                        This is a full-stack web application designed to
                        showcase and sell clothing items. The website features a
                        clean and user-friendly interface, making it easy for
                        customers to browse and purchase items. <br />
                        The website is built using the popular MERN stack,
                        including MongoDB for data storage, Express for
                        server-side logic, React for the front-end user
                        interface, and Node.js for the back-end runtime
                        environment. This technology stack provides a robust,
                        scalable, and efficient platform for the website,
                    ...
                    <li class="awilo_fn_masonry_in">
                      <div class="list_item">
                        ...
                        <div class="title_holder">
                          ...
                          <div class="title_name">
                            <h3>
                              <a href="https://realstateedc.netlify.app/">
                                K.M.E
                              </a>
                            </h3>
                          </div>
                      ...
                      <p style={{ color: "white" }}>
                        ...
                        robust API, Browse a collection of properties and find
                    ...
                    <li class="awilo_fn_masonry_in">
                      <div class="list_item">
                        ...
                        <div class="title_holder">
                          ...
                          <div class="title_name">
                            <h3>
                              <a href="https://brazilwc.netlify.app/">
                                Brazil W.C
                              </a>
                            </h3>
                          </div>
                      ...
                      <p style={{ color: "white" }}>
                        Step into the world of Brazilian soccer with this
                        portfolio project, a celebration of Brazil's world cup
                        titles. Built using HTML and CSS, this website brings
                        the old internet style to life, showcasing the country's
                        glorious victories in the most prestigious tournament in
                        world football.
                      </p>
                    </li>
                  </Link>
